...
const ClaimHistory = ({navigation}) => {
  ...
  const onRefresh = useCallback(() => {
    setRefresh(true), getHistoryDetails();
    setTimeout(() => {
      setRefresh(false);
    }, 1000);
  });
      ...
      {paymenyHistory != '' ? (
        <>
          <View style={styles.boxHeadings}>
            <Text
              style={[styles.fontText11, {width: windowWidth * (10 / 100)}]}>
              Id
            </Text>
            <Text
              style={[styles.fontText11, {width: windowWidth * (25 / 100)}]}>
              Redeem date
            </Text>
            <Text
              style={[styles.fontText11, {width: windowWidth * (30 / 100)}]}>
              Package Name
            </Text>
            <Text
              style={[styles.fontText11, {width: windowWidth * (25 / 100)}]}>
            ...
            renderItem={({item}) => (
              <View style={styles.subboxText}>
                ...
                <Text
                  ...
                  {moment(item?.packClaimDate).format('DD-MMM-YYYY hh:mm a')}
                </Text>
                <Text
                  numberOfLines={2}
                  style={[
