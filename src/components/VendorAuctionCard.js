        ...
        <View style={styles.container}>
              ...
              {highBid && (
                <View style={{flexDirection: 'row'}}>
                  <View
                    ...
                    {showIcon('bid', colours.primaryGreen, 16)}
                  </View>
                  <Text
                    style={[
                      styles.fontText2,
              ...
              <View>
                <View style={{flexDirection: 'row', marginTop: 5}}>
                  <View
                    ...
                    {showIcon('speedometer', colours.primaryBlack, 16)}
                  </View>
                  <Text
                    style={[
                      styles.fontText2,
                ...
                <View style={{flexDirection: 'row', marginTop: 5}}>
                  <View
                    ...
                    {showIcon('location', colours.primaryBlack, 16)}
                  </View>
                  <Text
                    style={[
                      styles.fontText2,
          ...
          <View style={styles.box1}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <View
                ...
                {showIcon('calendar', colours.primaryBlack, 16)}
              </View>
              <Text
                style={[
                  styles.fontText2,
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <View
                ...
                {showIcon('timer', colours.primaryBlack, 16)}
              </View>
              {isExpired ? (
                <Text
                  style={[
          ...
          <View style={styles.box2}>
            <Text style={styles.fontText2}>
              Inc {formatCurrency({amount: IncAmount, code: 'INR'})[0]}
            </Text>
            {FromVendor ? (
              ...
              <MaskedText
                mask={
                  isNaN(registerNumber.charAt(2)) ? 'AAA ******' : 'AA 99****'
                }
            ...
            <View
              ...
              {bidAmounts && (
                <Text style={styles.fontText3}>
                  {formatCurrency({amount: bidAmounts, code: 'INR'})[0]}
                </Text>
              )}
            </View>
            ...
            <View style={[styles.box1, {justifyContent: 'center'}]}>
              <Text
                style={[
                  ...
                  {
                    color:
                      YourLastBid >= bidAmounts
                        ? colours.primaryGreen
                        : colours.primaryRed,
                  },
                ]}>
                Your Last Bid Amount :{' '}
                {formatCurrency({amount: YourLastBid, code: 'INR'})[0]}
              </Text>
            </View>
          )}
        </View>
